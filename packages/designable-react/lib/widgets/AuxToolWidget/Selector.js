...
var useMouseHover = function useMouseHover(ref, enter, leave) {
...
exports.Selector = (0, reactive_react_1.observer)(function (_a) {
  ...
  var renderMenu = function renderMenu() {
    ...
    return react_1.default.createElement("div", {
      ...
      }, renderIcon(parent), react_1.default.createElement("span", {
        style: {
  ...
  }, renderIcon(node), react_1.default.createElement("span", null, react_1.default.createElement(NodeTitleWidget_1.NodeTitleWidget, {
    node: node
  }))), expand && renderMenu());
});
