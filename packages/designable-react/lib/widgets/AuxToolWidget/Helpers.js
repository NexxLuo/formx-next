...
var Helpers = function Helpers(_a) {
  var _b;
  ...
  (0, react_1.useLayoutEffect)(function () {
    ...
    var getYInViewport = function getYInViewport(nodeRect, helpersRect) {
    ...
    var getXInViewport = function getXInViewport(nodeRect, helpersRect) {
    ...
    update();
    return (0, reactive_1.reaction)(function () {
      return [viewport.width, viewport.height, viewport.scrollX, viewport.scrollY, viewport.isScrollBottom, viewport.isScrollTop];
    }, function () {
  ...
  return react_1.default.createElement("div", {
    className: (0, classnames_1.default)(prefix, (_b = {}, _b[position] = true, _b)),
    ref: ref
  }, react_1.default.createElement("div", {
    className: (0, classnames_1.default)(prefix + '-content')
  }, react_1.default.createElement(Selector_1.Selector, {
    node: node
  }), (node === null || node === void 0 ? void 0 : node.allowClone()) === false ? null : react_1.default.createElement(Copy_1.Copy, {
    node: node
  }), (node === null || node === void 0 ? void 0 : node.allowDrag()) === false ? null : react_1.default.createElement(DragHandler_1.DragHandler, {
    node: node
  }), (node === null || node === void 0 ? void 0 : node.allowDelete()) === false ? null : react_1.default.createElement(Delete_1.Delete, {
    node: node
  })));
};
