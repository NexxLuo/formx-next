...
const IconWidget = exports.IconWidget = (0, _observer.observer)(props => {
  ...
  const takeIcon = infer => {
    if ((0, _shared.isStr)(infer)) {
      ...
      if (infer[theme]) {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(IconWidget.ShadowSVG, {
          width: width,
          height: height,
  ...
  return renderTooltips( /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
    ...props,
