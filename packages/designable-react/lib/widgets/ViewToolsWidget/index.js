...
exports.ViewToolsWidget = (0, reactive_react_1.observer)(function (_a) {
  ...
  return react_1.default.createElement(antd_1.Button.Group, {
  ...
  }, use.includes('DESIGNABLE') && react_1.default.createElement(antd_1.Button, {
    ...
    infer: "Design"
  })), use.includes('JSONTREE') && react_1.default.createElement(antd_1.Button, {
    ...
    infer: "JSON"
  })), use.includes('MARKUP') && react_1.default.createElement(antd_1.Button, {
    ...
    infer: "Code"
  })), use.includes('PREVIEW') && react_1.default.createElement(antd_1.Button, {
