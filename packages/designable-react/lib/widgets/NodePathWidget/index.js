...
exports.NodePathWidget = (0, reactive_react_1.observer)(function (props) {
  ...
  var selected = (0, hooks_1.useCurrentNode)(props.workspaceId);
  ...
  if (!selected) return react_1.default.createElement(react_1.default.Fragment, null);
  var maxItems = (_a = props.maxItems) !== null && _a !== void 0 ? _a : 3;
  var nodes = selected.getParents().slice(0, maxItems - 1).reverse().concat(selected);
  return react_1.default.createElement(antd_1.Breadcrumb, {
    className: prefix
  }, nodes.map(function (node, key) {
    return react_1.default.createElement(antd_1.Breadcrumb.Item, {
      key: key
    }, key === 0 && react_1.default.createElement(IconWidget_1.IconWidget, {
      infer: "Position",
      style: {
        marginRight: 3
      }
