...
exports.Insertion = (0, reactive_react_1.observer)(function (_a) {
  ...
  var outlineDragon = (0, hooks_1.useOutlineDragon)(workspaceId);
  ...
  var createInsertionStyle = function createInsertionStyle() {
    ...
    if (closestDirection === core_1.ClosestPosition.After || closestDirection === core_1.ClosestPosition.InnerAfter || closestDirection === core_1.ClosestPosition.Under || closestDirection === core_1.ClosestPosition.ForbidAfter || closestDirection === core_1.ClosestPosition.ForbidInnerAfter || closestDirection === core_1.ClosestPosition.ForbidUnder) {
    ...
    } else if (closestDirection === core_1.ClosestPosition.Before || closestDirection === core_1.ClosestPosition.InnerBefore || closestDirection === core_1.ClosestPosition.Upper || closestDirection === core_1.ClosestPosition.ForbidBefore || closestDirection === core_1.ClosestPosition.ForbidInnerBefore || closestDirection === core_1.ClosestPosition.ForbidUpper) {
      baseStyle.width = closestRect.width;
      baseStyle.height = 2;
  ...
  if (!(outlineDragon === null || outlineDragon === void 0 ? void 0 : outlineDragon.closestNode)) return null;
