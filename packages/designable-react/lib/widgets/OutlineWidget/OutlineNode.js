...
exports.OutlineTreeNode = (0, reactive_react_1.observer)(function (_a) {
  ...
  var renderTitle = function renderTitle(node) {
    ...
    return react_1.default.createElement("span", null, react_1.default.createElement(NodeTitleWidget_1.NodeTitleWidget, {
      node: node
    }));
  };

  var renderActions = function renderActions(node) {
  ...
  }, (((_b = node === null || node === void 0 ? void 0 : node.children) === null || _b === void 0 ? void 0 : _b.length) > 0 || node === node.root) && react_1.default.createElement("div", {
  ...
  }, renderIcon(node)), react_1.default.createElement("div", {
    className: prefix + '-title'
  }, renderTitle(node))), react_1.default.createElement("div", {
    className: prefix + '-header-actions',
    "data-click-stop-propagation": true
  }, renderActions(node), node !== node.root && react_1.default.createElement(IconWidget_1.IconWidget, {
  ...
  }, (_c = node.children) === null || _c === void 0 ? void 0 : _c.map(function (child) {
