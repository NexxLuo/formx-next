...
exports.ArrayItems = (0, react_2.observer)(function (props) {
  ...
  return react_1.default.createElement(array_base_1.ArrayBase, null, react_1.default.createElement("div", __assign({}, props, {
...
exports.ArrayItems.Item = function (props) {
  ...
  return react_1.default.createElement("div", __assign({}, props, {
    onChange: function onChange() {},
    className: (0, classnames_1.default)("".concat(prefixCls, "-").concat(props.type || "card"), props.className)
  }), props.children);
};
