...
var useFormLayout = function useFormLayout() {
  return __assign(__assign({}, (0, exports.useFormDeepLayout)()), (0, exports.useFormShallowLayout)());
};

exports.useFormLayout = useFormLayout;

var FormLayout = function FormLayout(_a) {
  var _b;
  ...
  var shallow = _a.shallow,
      ...
      style = _a.style,
      otherProps = __rest(_a, ["shallow", "children", "prefixCls", "className", "style"]);
  ...
  var layoutClassName = (0, classnames_1.default)(layoutPrefixCls, (_b = {}, _b["".concat(formPrefixCls, "-").concat(props.layout)] = true, _b["".concat(formPrefixCls, "-rtl")] = props.direction === 'rtl', _b["".concat(formPrefixCls, "-").concat(props.size)] = props.size, _b), className);
  ...
  var renderChildren = function renderChildren() {
    ...
    return react_1.default.createElement(exports.FormLayoutDeepContext.Provider, {
      value: newDeepLayout
    }, react_1.default.createElement(exports.FormLayoutShallowContext.Provider, {
