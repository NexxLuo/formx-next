...
var getImageByUrl = function getImageByUrl(url, options) {
  for (var i = 0; i < placeholder_1.UPLOAD_PLACEHOLDER.length; i++) {
    if (placeholder_1.UPLOAD_PLACEHOLDER[i].ext.test(url) && testOpts(placeholder_1.UPLOAD_PLACEHOLDER[i].ext, options)) {
...
var useUploadValidator = function useUploadValidator(serviceErrorMessage) {
  ...
  useValidator(function (value) {
    ...
    for (var i = 0; i < list.length; i++) {
      if (((_a = list[i]) === null || _a === void 0 ? void 0 : _a.status) === 'error') {
        return getErrorMessage((_b = list[i]) === null || _b === void 0 ? void 0 : _b.response) || getErrorMessage(list[i]) || serviceErrorMessage;
      }
    }
  });
};
...
var getPlaceholder = function getPlaceholder(props) {
  if (props.listType !== 'picture-card') {
    return react_1.default.createElement(antd_1.Button, null, react_1.default.createElement(icons_1.UploadOutlined, null), props.textContent);
  }
...
var Dragger = (0, react_2.connect)(function (props) {
  ...
  }, react_1.default.createElement(antd_1.Upload.Dragger, __assign({}, useUploadProps(props)), props.children || react_1.default.createElement(react_1.default.Fragment, null, react_1.default.createElement("p", {
    className: "ant-upload-drag-icon"
  }, react_1.default.createElement(icons_1.InboxOutlined, null)), props.textContent && react_1.default.createElement("p", {
