...
function FormDialog(title, id, renderer) {
  ...
  var DialogContent = (0, react_2.observer)(function () {
    return react_1.default.createElement(react_1.Fragment, null, (0, shared_1.isFn)(renderer) ? renderer(env.form) : renderer);
  });

  var renderDialog = function renderDialog(visible, resolve, reject) {
    if (visible === void 0) {
      visible = true;
    }

    return react_1.default.createElement(react_2.Observer, null, function () {
      return react_1.default.createElement(antd_1.Modal, __assign({}, modal, {
        visible: visible,
      ...
      }), react_1.default.createElement(react_2.FormProvider, {
        form: env.form
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    ...
                    return [4
                    /*yield*/
                    , (0, __builtins__1.loading)(modal.loadingText, function () {
                            ...
                            return __generator(this, function (_a) {
                              switch (_a.label) {
                                case 0:
                                  return [4
                                  /*yield*/
                                  , (0, shared_1.applyMiddleware)(env.form, env.confirmMiddlewares)];
