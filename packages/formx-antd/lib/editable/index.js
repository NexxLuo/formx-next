...
exports.Editable = (0, react_2.observer)(function (props) {
  ...
  var renderEditHelper = function renderEditHelper() {
    if (editable) return;
    return react_1.default.createElement(form_item_1.BaseItem, __assign({}, props, itemProps), pattern === 'editable' && react_1.default.createElement(icons_1.EditOutlined, {
      className: "".concat(prefixCls, "-edit-btn")
    }), pattern !== 'editable' && react_1.default.createElement(icons_1.MessageOutlined, {
      className: "".concat(prefixCls, "-edit-btn")
    }));
  };
  ...
  var renderCloseHelper = function renderCloseHelper() {
    if (!editable) return;
    return react_1.default.createElement(form_item_1.BaseItem, __assign({}, props), react_1.default.createElement(icons_1.CloseOutlined, {
  ...
  (0, __builtins__1.useClickAway)(function (e) {
    var target = e.target;
    if (target === null || target === void 0 ? void 0 : target.closest(".".concat(basePrefixCls, "-select-dropdown"))) return;
    if (target === null || target === void 0 ? void 0 : target.closest(".".concat(basePrefixCls, "-picker-dropdown"))) return;
    if (target === null || target === void 0 ? void 0 : target.closest(".".concat(basePrefixCls, "-cascader-menus"))) return;
    recover();
  }, innerRef);
  ...
  }, react_1.default.createElement(form_item_1.BaseItem, __assign({}, props, itemProps), props.children), renderEditHelper(), renderCloseHelper()));
});
exports.Editable.Popover = (0, react_2.observer)(function (props) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            if (errors === null || errors === void 0 ? void 0 : errors.length) return [2
            /*return*/
            ];
            setVisible(false);
            return [7
  ...
  return react_1.default.createElement(antd_1.Popover, __assign({}, props, {
  ...
  }), react_1.default.createElement("div", null, react_1.default.createElement(form_item_1.BaseItem, {
    className: "".concat(prefixCls, "-trigger")
  }, react_1.default.createElement("div", {
    className: "".concat(prefixCls, "-content")
  }, react_1.default.createElement("span", {
    className: "".concat(prefixCls, "-preview")
  }, props.title || field.title), pattern === 'editable' && react_1.default.createElement(icons_1.EditOutlined, {
    className: "".concat(prefixCls, "-edit-btn")
  }), pattern !== 'editable' && react_1.default.createElement(icons_1.MessageOutlined, {
    className: "".concat(prefixCls, "-edit-btn")
  })))));
