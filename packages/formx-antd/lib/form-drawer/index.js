...
function FormDrawer(title, id, renderer) {
  ...
  var renderDrawer = function renderDrawer(visible) {
    if (visible === void 0) {
      visible = true;
    }

    return react_1.default.createElement(antd_1.Drawer, __assign({}, drawer, {
      visible: visible
        ...
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                props = _a.sent();
                env.form = env.form || (0, core_1.createForm)(__assign(__assign({}, props), {
