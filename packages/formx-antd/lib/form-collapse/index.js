...
var usePanels = function usePanels() {
  ...
  schema.mapProperties(function (schema, name) {
    ...
    if (((_a = schema["x-component"]) === null || _a === void 0 ? void 0 : _a.indexOf("CollapsePanel")) > -1) {
      panels.push({
        name: name,
        props: __assign(__assign({}, schema === null || schema === void 0 ? void 0 : schema["x-component-props"]), {
...
var createFormCollapse = function createFormCollapse(defaultActiveKeys) {
  var formCollapse = (0, reactive_1.model)({
    activeKeys: defaultActiveKeys,
    setActiveKeys: function setActiveKeys(keys) {
      formCollapse.activeKeys = keys;
    },
    hasActiveKey: function hasActiveKey(key) {
    ...
    toggleActiveKey: function toggleActiveKey(key) {
...
exports.FormCollapse = (0, react_2.observer)(function (_a) {
  ...
  var takeActiveKeys = function takeActiveKeys() {
    var _a;

    if (props.activeKey) return props.activeKey;
    if (_formCollapse === null || _formCollapse === void 0 ? void 0 : _formCollapse.activeKeys) return _formCollapse === null || _formCollapse === void 0 ? void 0 : _formCollapse.activeKeys;
    if (props.accordion) return (_a = panels[0]) === null || _a === void 0 ? void 0 : _a.name;
    return panels.map(function (item) {
      return item.name;
    });
  };

  var badgedHeader = function badgedHeader(key, props) {
  ...
  return react_1.default.createElement(antd_1.Collapse, __assign({}, props, {
    ...
    var props = _a.props,
        schema = _a.schema,
        name = _a.name;
    return react_1.default.createElement(antd_1.Collapse.Panel, __assign({
      key: index
    }, props, {
