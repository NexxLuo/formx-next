...
var parseSteps = function parseSteps(schema) {
  var steps = [];
...
var createFormStep = function createFormStep(defaultCurrent) {
  ...
  var _next = reactive_1.action.bound(function () {
  ...
  var _back = reactive_1.action.bound(function () {
  ...
  var formStep = (0, reactive_1.model)({
    connect: function connect(steps, field) {
      env.steps = steps;
    ...
    submit: function submit(onSubmit) {
      ...
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_c) {
          return [2
          /*return*/
          , (_b = (_a = env.form) === null || _a === void 0 ? void 0 : _a.submit) === null || _b === void 0 ? void 0 : _b.call(_a, onSubmit)];
        });
      });
    }
  });
...
exports.FormStep = (0, react_2.connect)((0, react_2.observer)(function (_a) {
  ...
  return react_1.default.createElement("div", {
  ...
  }, react_1.default.createElement(antd_1.Steps, __assign({}, props, {
    style: __assign({
      marginBottom: 10
    }, props.style),
    current: current
    ...
    var props = _a.props;
    return react_1.default.createElement(antd_1.Steps.Step, __assign({}, props, {
      key: key
    }));
  })), steps.map(function (_a, key) {
    var name = _a.name,
...
var StepPane = function StepPane(_a) {
