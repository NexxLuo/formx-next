...
var useGridSpan = function useGridSpan(gridSpan) {
  if (gridSpan === void 0) {
    gridSpan = 1;
  }
...
var useGridColumn = function useGridColumn(gridSpan) {
  if (gridSpan === void 0) {
    gridSpan = 1;
  }
...
exports.FormGrid = (0, react_2.observer)(function (_a) {
  ...
  var options = __assign({
    columnGap: (_b = layout === null || layout === void 0 ? void 0 : layout.gridColumnGap) !== null && _b !== void 0 ? _b : 8,
    rowGap: (_c = layout === null || layout === void 0 ? void 0 : layout.gridRowGap) !== null && _c !== void 0 ? _c : 4
  }, props);

  var grid = (0, react_1.useMemo)(function () {
    return (0, reactive_1.markRaw)((options === null || options === void 0 ? void 0 : options.grid) ? options.grid : new grid_1.Grid(options));
  ...
  return react_1.default.createElement(FormGridContext.Provider, {
    value: grid
  }, react_1.default.createElement("div", __assign({}, dataProps, {
    className: (0, classnames_1.default)("".concat(prefixCls, "-layout"), className),
