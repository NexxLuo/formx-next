...
var PositionInput = function PositionInput(props) {
  var prefix = (0, designable_react_1.usePrefix)('position-input');
  ...
  }, react_1.default.createElement("div", __assign({}, createCellProps('top')), "\u2533")), react_1.default.createElement("div", {
    className: prefix + '-row'
  }, react_1.default.createElement("div", __assign({}, createCellProps('left')), "\u2523"), react_1.default.createElement("div", __assign({}, createCellProps('center')), "\u254B"), react_1.default.createElement("div", __assign({}, createCellProps('right')), "\u252B")), react_1.default.createElement("div", {
    className: prefix + '-row'
