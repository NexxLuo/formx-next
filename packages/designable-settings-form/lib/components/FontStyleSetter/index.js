...
var createFontFamilyOptions = function createFontFamilyOptions(fonts) {
...
exports.FontStyleSetter = (0, react_2.observer)(function (props) {
  var field = (0, react_2.useField)();
  var prefix = (0, designable_react_1.usePrefix)('font-style-setter');
  return react_1.default.createElement(FoldItem_1.FoldItem, {
    ...
    name: "fontWeight",
    basePath: field.address.parent(),
    component: [formx_antd_1.NumberPicker, {
      placeholder: '400'
    }]
