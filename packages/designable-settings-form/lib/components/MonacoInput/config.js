          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4
                /*yield*/
                , (0, format_1.format)(((_a = model['getDesignerLanguage']) === null || _a === void 0 ? void 0 : _a.call(model)) || 'typescript', model.getValue())];

              case 1:
                return [2
                /*return*/
                , [(_b.text = _c.sent(), _b.range = model.getFullModelRange(), _b)]];
            }
          });
        });
      }
