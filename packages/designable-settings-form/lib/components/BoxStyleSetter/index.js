...
exports.BoxStyleSetter = (0, react_2.observer)(function (props) {
  ...
  var prefix = (0, designable_react_1.usePrefix)('box-style-setter');

  var createPositionHandler = function createPositionHandler(position, props) {
  ...
  return react_1.default.createElement(FoldItem_1.FoldItem, {
    ...
    label: field.title
  }, react_1.default.createElement(FoldItem_1.FoldItem.Base, null, react_1.default.createElement(SizeInput_1.SizeInput, __assign({}, createPositionHandler('all', props), {
    exclude: ['inherit', 'auto']
  }))), react_1.default.createElement(FoldItem_1.FoldItem.Extra, null, react_1.default.createElement(InputItems_1.InputItems, {
    width: "50%"
  }, react_1.default.createElement(InputItems_1.InputItems.Item, {
    icon: props.labels[0]
  }, react_1.default.createElement(SizeInput_1.SizeInput, __assign({}, createPositionHandler('top', props), {
    exclude: ['inherit', 'auto']
  }))), react_1.default.createElement(InputItems_1.InputItems.Item, {
    icon: props.labels[1]
  }, react_1.default.createElement(SizeInput_1.SizeInput, __assign({}, createPositionHandler('right', props), {
    exclude: ['inherit', 'auto']
  }))), react_1.default.createElement(InputItems_1.InputItems.Item, {
    icon: props.labels[2]
  }, react_1.default.createElement(SizeInput_1.SizeInput, __assign({}, createPositionHandler('bottom', props), {
    exclude: ['inherit', 'auto']
  }))), react_1.default.createElement(InputItems_1.InputItems.Item, {
    icon: props.labels[3]
  }, react_1.default.createElement(SizeInput_1.SizeInput, __assign({}, createPositionHandler('left', props), {
    exclude: ['inherit', 'auto']
  }))))));
});
