import { ItemExtra, ItemLayout, ItemComponentProps } from "./extra";
...
export const Field = {
  "zh-CN": {
    settings: {
      ...
      "layout-group": "布局属性",
      "extra-group": "扩展属性",
      "attribute-group": "自定义属性",
      "x-component-props": {
        ...ItemComponentProps["zh-CN"],
        ...
        "x-layout-props": ItemLayout["zh-CN"],
        "x-extra-props": ItemExtra["zh-CN"]
      },
      "x-decorator-props": {
        addonAfter: "后缀标签",
        addonBefore: "前缀标签",
